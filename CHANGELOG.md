...
* [ENHANCEMENT] Compactor: If compaction fails because the result block would exceed the 64GiB index size limit or the 4GB symbol table size limit, mark input blocks for no-compaction to avoid blocking future compactor runs. #TODO
